...
- **Direktversand aus dem Mail-Generator** (2026-08-10): "E-Mail senden"-Button neben "In Zwischenablage kopieren" öffnet einen `mailto:`-Link mit vorausgefülltem Empfänger/Betreff/Text im eigenen E-Mail-Programm des Nutzers — kein serverseitiger Versand, keine Zugangsdaten/Tokens auf der Seite. Bewusste Entscheidung gegen echten API-Versand (z. B. Gmail API): hätte einen erweiterten OAuth-Scope (Neu-Login für alle) und sicher gespeicherte, versandfähige Tokens serverseitig gebraucht — deutlich mehr Angriffsfläche für relativ wenig Zusatznutzen, da die Mail dank `mailto:` ohnehin ganz normal im echten Gesendet-Ordner des Nutzers landet.
